...
function handleItemDeletes(formElement, removeIdentifier, itemDataAttr, listElement, state) {
    listElement.on('click', removeIdentifier, function(event) {
        var itemIndex = parseInt($(this).closest('li').attr(itemDataArr));
...
$(function() {
    ...
    var itemDatAttr = 'data-list-item-id';
    ...
    handlItemToggles(listElement, toggleIdentifier, itemDataAttr, state);
});
